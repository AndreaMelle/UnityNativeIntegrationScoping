...
struct  ExtendedKeyUsageExtension_t1503  : public X509Extension_t1399
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t1136 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1503_StaticFields{
	...
	Dictionary_2_t307 * ___U3CU3Ef__switchU24map14_4;
};
