...
struct List_1_t964_StaticFields{
	// T[] System.Collections.Generic.List`1<Vuforia.ITrackerEventHandler>::EmptyArray
	ITrackerEventHandlerU5BU5D_t3119* ___EmptyArray_4;
};
