...
struct  X509Store_t1289  : public Object_t
{
	...
	X509Certificate2Collection_t1281 * ___list_2;
	...
	X509Store_t1302 * ___store_4;
};
struct X509Store_t1289_StaticFields{
	...
	Dictionary_2_t307 * ___U3CU3Ef__switchU24mapF_5;
};
