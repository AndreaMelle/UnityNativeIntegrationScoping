...
struct  List_1_t912  : public Object_t
{
	// T[] System.Collections.Generic.List`1<Vuforia.WordAbstractBehaviour>::_items
	WordAbstractBehaviourU5BU5D_t1053* ____items_1;
...
struct List_1_t912_StaticFields{
	// T[] System.Collections.Generic.List`1<Vuforia.WordAbstractBehaviour>::EmptyArray
	WordAbstractBehaviourU5BU5D_t1053* ___EmptyArray_4;
};
