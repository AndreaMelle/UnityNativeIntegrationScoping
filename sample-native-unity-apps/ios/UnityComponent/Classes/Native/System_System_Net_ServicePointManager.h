...
struct  ServicePointManager_t116  : public Object_t
{
};
struct ServicePointManager_t116_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t1126 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t18 * ___server_cert_cb_9;
};
