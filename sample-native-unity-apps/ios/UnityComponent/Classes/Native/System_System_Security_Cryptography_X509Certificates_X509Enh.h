...
struct  X509EnhancedKeyUsageExtension_t1294  : public X509Extension_t1277
{
	...
	OidCollection_t1292 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t1294_StaticFields{
	...
	Dictionary_2_t307 * ___U3CU3Ef__switchU24mapE_6;
};
