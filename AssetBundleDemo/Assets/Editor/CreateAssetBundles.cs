...
public class CreateAssetBundles
{
    ...
    [MenuItem("Assets/Clear AssetBundle Output Dir")]
    ...
    [MenuItem("Assets/Clear AssetBundle Cache")]
    static void ClearAssetBundleCache()
    {
        Caching.CleanCache();
    }

    [MenuItem("Assets/Clear AssetBundle Metadata Cache")]
    static void ClearAssetBundleMetadataCache()
    {
    ...
    static void BuildAllAssetBundles()
    {
        ...
        var aws_upload = new Process
        {
            StartInfo = new ProcessStartInfo
            {
                ...
                FileName = "AWSScripts/asset-bundles-sync.bat",
#endif
